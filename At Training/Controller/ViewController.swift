...
class ViewController: UIViewController {
    ...
    var onHomePage: Bool = false //for taking care of pop-up of not connected showing on other pages
    ...
    {
        if(onHomePage == true){
            let alert = UIAlertController(title: "No AHRS Wi-fi Connection Found / Poor Connection", message: "Strong Connection with AHRS Device Required. Go to Settings>Wi-Fi>(select your AHRS device)", preferredStyle: .alert)
            let action = UIAlertAction(title: "OK", style: .default)
            {
                (action) in
    ...
    override func viewWillAppear(_ animated: Bool) {
            onHomePage =  true                      //for taking care of pop-up of not connected showing on other pages
    ...
    override func viewWillDisappear(_ animated: Bool) {
        onHomePage = false //for taking care of pop-up of not connected showing on other pages
    }
