...
class CalibrationVC: UIViewController {
    ...
    func caliberationValueBringer() {
        ...
        //values are ALWAYS to be brought in the background thread for creating simulations and updating UI in real-time. Follow this in every ViewController.
        DispatchQueue.global(qos: .background).async {
            ...
            while (continueReceiving == 10) //10 is treated as a true. Change data type to bool for convenience.
            {
